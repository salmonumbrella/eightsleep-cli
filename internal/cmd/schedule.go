...
func init() {
	...
	_ = viper.BindPFlag("start", scheduleCreateCmd.Flags().Lookup("start"))
	_ = viper.BindPFlag("level", scheduleCreateCmd.Flags().Lookup("level"))
	_ = viper.BindPFlag("days", scheduleCreateCmd.Flags().Lookup("days"))
	_ = viper.BindPFlag("disabled", scheduleCreateCmd.Flags().Lookup("disabled"))
	...
	_ = viper.BindPFlag("start", scheduleUpdateCmd.Flags().Lookup("start"))
	_ = viper.BindPFlag("level", scheduleUpdateCmd.Flags().Lookup("level"))
	_ = viper.BindPFlag("days", scheduleUpdateCmd.Flags().Lookup("days"))
	_ = viper.BindPFlag("enabled", scheduleUpdateCmd.Flags().Lookup("enabled"))
